...
def upload_file():
    ...
    success, message = file_system.upload_file(session['user_email'], file, file.filename)
...
def download_file(file_id):
    ...
    success, message, file_data, filename = file_system.download_file(session['user_email'], file_id)
